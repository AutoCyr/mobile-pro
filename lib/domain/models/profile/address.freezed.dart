...
class _$AddressImpl implements _Address {
  ...
  @override
  String toString() {
    return 'Address(libelle: $libelle, latitude: $latitude, longitude: $longitude, status: $status)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, libelle, latitude, longitude, status);
...
abstract class _Address implements Address {
  const factory _Address(
      ...
      @JsonKey(name: 'statut') required final int status}) = _$AddressImpl;
